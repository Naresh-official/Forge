        ...
        <div className="rounded-lg border border-border bg-card p-6 max-sm:p-4">
            ...
            <>
              ...
              <div className="mt-3 space-y-1.5">
                {repos.map((name) => (
                  ...
                  >
                    <span className="grid size-7 place-items-center rounded-md bg-secondary text-xs text-primary">
                      {name[0].toUpperCase()}
                    </span>
                    <span className="flex flex-1 flex-col gap-1">
                      <strong className="text-[11px]">acme/{name}</strong>
          ...
          {step === 2 && (
            <>
              <StepTitle
                ...
                description="Forge detected sensible defaults for your repository."
              />
          ...
          {step === 3 && (
            <>
              <StepTitle
                icon={
                  <span className="grid size-5 place-items-center rounded border border-primary text-primary">
                    ✓
                  </span>
                }
                title="Environment variables"
                description="Add secrets and configuration for your deployment."
              />
          ...
          {step === 4 && (
            <>
              <StepTitle
                ...
                description="Review your configuration before creating the project."
              />
